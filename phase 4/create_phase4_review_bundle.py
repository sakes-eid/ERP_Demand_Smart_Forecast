"""Create a clean Phase 4 Step 4A capacity review bundle."""
...
ZIP_PATH = PROJECT_ROOT / "phase4_step4a_capacity_review_bundle.zip"
...
def _build_manifest(
    ...
    lines = [
        "Phase 4 Step 4A Capacity Review Bundle Manifest",
