"""Run the Phase 1 data foundation pipeline end to end."""
...
def run_pipeline() -> None:
    """Load, validate, clean, inspect, and export Phase 1 data outputs."""
    ...
    forecast_results, model_performance, model_registry, forecasting_diagnostics = run_baseline_forecasting(demand_features)
...
def print_forecasting_summary(forecast_results, model_performance, model_registry, forecasting_diagnostics) -> None:
    """Print a compact summary of baseline forecasting outputs."""
